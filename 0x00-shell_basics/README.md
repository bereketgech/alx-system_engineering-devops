A shell is a program that takes command from the keyboard and gives them to the operating system to perform. A terminal is a program that opens a window and lets you interact with the shell.
Files Descriptions
